import re
import cv2
from tool.tool import expand_boxes
...
conf: [Model will output a specific confidence threshold value between 0.2 and 0.8] \n
'''
...
def tailor(v10,model,tokenizer,img):
    ...
    threshold = conf_threshold if conf_threshold is not None else 0.5
    ...
    expanded_boxes = expand_boxes(boxes,w,h)
    ...
    for b in expanded_boxes:
        ...
        # 保存裁剪的图像
        output_path = f"Tailor/cropped_{k}.jpg"
